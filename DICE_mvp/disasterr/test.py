...
def run_test(input):
        ...
        save_inference_path='c:/Users/yongh/OneDrive/바탕 화면/hello_django (2)/deep_server/'#'/home/ec2-user/yuddomack/product/disasterr/checkpoint/'
        ...
        Bert_model = BertForSequenceClassification.from_pretrained(
            "garynguyen1174/disaster_tweet_bert", #12-layer BERT model, with an uncased vocab.
